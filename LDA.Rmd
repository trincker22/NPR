...
# 1. Collapse to 1 observation per episode (full transcript and guest-only)
...
# 2. Collapse host names to comma-separated string per episode
...
# 3. Define safe left_join function to avoid overwriting existing columns
...
# 4. Loop through both datasets to attach host metadata and enrich features
for (df_name in c("ep_utterances", "ep_utterancesG")) {
  ...
  # Save processed data frame back to environment
