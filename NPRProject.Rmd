...
classify_immigration_frame <- function(text) {
  ...
  prompt <- paste(
    ...
    "1. Security/Threat Frame:\n",
    "Articles that primarily frame immigration as a threat to national security, public safety, or the legal order.\n",
    "Includes illegal entry, smuggling, border crossings, ICE raids, deportations, crime, terrorism, national security concerns, law-and-order rhetoric.\n",
    "Keywords: illegal, deportation, border wall, crime, ICE, security, terrorism, smuggling, cartels, public safety\n\n",
    
    "2. Economic Frame:\n",
    "Articles focusing on the financial or labor market implications of immigration.\n",
    "Includes immigrant workers, funding, wages, employment, taxes, entrepreneurship, remittances, business demand, fiscal burden or benefit.\n",
    "Keywords: jobs, labor, taxes, contribution, costs, economic growth, shortages, employment, undocumented workers\n\n",
    
    "3. Humanitarian/Moral Frame:\n",
    "Articles highlighting lived experiences, rights, or moral standing of immigrants/refugees.\n",
    "Includes asylum seekers, refugees, family separation, living conditions, trauma, discrimination, civil society efforts.\n",
    "Keywords: asylum, refugee, family, rights, trauma, detention, inclusion, discrimination, DACA, compassion, migrant children\n\n",
    
    "4. Other:\n",
    "Overly procedural discussions or broad political overviews that only tangentially mention immigration.\n\n",
    
    "Important: Even if a story seems sympathetic, if it evokes associations with security or crime (e.g., fleeing violence from cartels), classify as Security/Threat.\n\n",
